            ...
            <section id="knowledge">
                ...
                <div className="blocks">
                    <div className="box" id="box1">
                        ...
                        <a href="https://drive.google.com/file/d/1GKdKO29vzOzvEf28OQ8ahxjEN5Vy3a6E/view?usp=sharing" rel="noreferrer" target="_blank" className="btn" id="resume">View My Resume</a>
                    </div>
